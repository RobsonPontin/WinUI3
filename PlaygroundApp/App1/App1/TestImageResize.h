...
namespace Playground
{
    ...
    struct TestImageResize
    {
        ...
        WF::IAsyncOperation<WGI::SoftwareBitmap> ResizeImageWinRtAsync(WS::Streams::IRandomAccessStream imageStream, uint32_t targetSize);
        WF::IAsyncOperation<WGI::SoftwareBitmap> ResizeImageWICAsync(std::wstring_view const& path, uint32_t targetSize);

...
// 
// However, the tool didn't do a very good job, so I had to fix it.
// This has been copied from GeneratedFiles\App.xaml.g.h and modified.
// If any issues arise, please compare this file to the original.
//
//------------------------------------------------------------------------------
...
namespace winrt::CsCppApp::implementation
{
    ...
    struct AppT: public ::winrt::Microsoft::UI::Xaml::ApplicationT<D, ::winrt::Microsoft::UI::Xaml::Markup::IXamlMetadataProvider, Interfaces...>
    {
        ...
        void AddOtherProvider(::winrt::Microsoft::UI::Xaml::Markup::IXamlMetadataProvider const& otherProvider)
        {
            ...
            // It was using . instead of ->, which is wrong.
